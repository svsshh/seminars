// Console.Write("Напишите программу, которая принимает на вход пятизначное число и проверяет, является ли оно палиндромом.");
// Console.Write("Введи число: ");
// string text = Console.ReadLine();
// if (text.Length == 5)
//     while (text[0] = text[4] && text[1] = text[3])
//     {
//         Console.Write("Это число - палиндром");
//     }
// else if (text.Length > 5 || text.Length < 5)
// {
